    ...
    },
    {
      ...
      paragraphs: {
        "ko": [
          ...
          "채팅 저장은 외부 LLM을 mock으로 대체하고, 5,000개 가상 사용자에 10~60초 대기 시간을 둔 동일한 부하 조건에서 기존 구조와 개선 구조를 비교했습니다. 메시지·세션 갱신의 DB 왕복을 줄이고 채팅 환불 원장을 사용자별로 합산한 후보에서 DB pool 최대 사용은 79/80에서 10/80으로, 측정 중 최대 DB ping은 409.32ms에서 2.14ms로 감소했습니다.",
      ...
      metrics: [
        ...
        },
        {
          "label": {
            "ko": "최대 DB 연결 · 변경 전후",
            "en": "Peak DB connections · before/after"
          },
          "before": "79/80",
          "after": "10/80"
        },
